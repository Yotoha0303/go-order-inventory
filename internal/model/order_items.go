...
type OrderItem struct {
	...
	ProdcutName     string    `gorm:"type:varchar(100);not null" json:"product_name"`
	ProductPriceFen int64     `gorm:"column:product_price_fen;type:bigint;not null" json:"product_price"`
